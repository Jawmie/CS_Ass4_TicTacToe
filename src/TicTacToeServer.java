...
public class TicTacToeServer extends JFrame {
   ...
   public boolean isGameOver()
   {
      ...
      if( board[ 0 ] == X_MARK && board[ 1 ] == X_MARK && board[ 2 ] == X_MARK){
         displayMessage( "\nPlayer " + currentPlayer  + " is the winner" );//make current player the winner
         return true;
      }
      if( board[ 3 ] == X_MARK && board[ 4 ] == X_MARK && board[ 5 ] == X_MARK){
         displayMessage( "\nPlayer " + currentPlayer  + " is the winner" );//make current player the winner
         return true;
      }
      if( board[ 6 ] == X_MARK && board[ 7 ] == X_MARK && board[ 8 ] == X_MARK){
         displayMessage( "\nPlayer " + currentPlayer  + " is the winner" );//make current player the winner
         return true;
      }
      ...
      if( board[ 2 ] == X_MARK && board[ 4 ] == X_MARK && board[ 6 ] == X_MARK){
         displayMessage( "\nPlayer " + currentPlayer  + " is the winner" );//make current player the winner
         return true;
      }
      if( board[ 0 ] == X_MARK && board[ 3 ] == X_MARK && board[ 6 ] == X_MARK){
         displayMessage( "\nPlayer " + currentPlayer  + " is the winner" );//make current player the winner
         return true;
      }
      if( board[ 1 ] == X_MARK && board[ 4 ] == X_MARK && board[ 7 ] == X_MARK){
         displayMessage( "\nPlayer " + currentPlayer  + " is the winner" );//make current player the winner
         return true;
      }
      if( board[ 2 ] == X_MARK && board[ 5 ] == X_MARK && board[ 8 ] == X_MARK){
         displayMessage( "\nPlayer " + currentPlayer  + " is the winner" );//make current player the winner
         return true;
      }
      //O player wins
      if( board[ 0 ] == O_MARK && board[ 1 ] == O_MARK && board[ 2 ] == O_MARK){
         displayMessage( "\nPlayer " + currentPlayer  + " is the winner" );//make current player the winner
         return true;
      }
      if( board[ 3 ] == O_MARK && board[ 4 ] == O_MARK && board[ 5 ] == O_MARK){
         displayMessage( "\nPlayer " + currentPlayer  + " is the winner" );//make current player the winner
         return true;
      }
      if( board[ 6 ] == O_MARK && board[ 7 ] == O_MARK && board[ 8 ] == O_MARK){
         displayMessage( "\nPlayer " + currentPlayer  + " is the winner" );//make current player the winner
         return true;
      }
      ...
      if( board[ 2 ] == O_MARK && board[ 4 ] == O_MARK && board[ 6 ] == O_MARK){
         displayMessage( "\nPlayer " + currentPlayer  + " is the winner" );//make current player the winner
         return true;
      }
      if( board[ 0 ] == O_MARK && board[ 3 ] == O_MARK && board[ 6 ] == O_MARK){
         displayMessage( "\nPlayer " + currentPlayer  + " is the winner" );//make current player the winner
         return true;
      }
      if( board[ 1 ] == O_MARK && board[ 4 ] == O_MARK && board[ 7 ] == O_MARK){
         displayMessage( "\nPlayer " + currentPlayer  + " is the winner" );//make current player the winner
         return true;
      }
      if( board[ 2 ] == O_MARK && board[ 5 ] == O_MARK && board[ 8 ] == O_MARK){
         displayMessage( "\nPlayer " + currentPlayer  + " is the winner" );//make current player the winner
         return true;
      }
      else {
   ...
   private class Player extends Thread {
      ...
      // send message to other player that they lost and that the other player won here
      ...
      public void run()
      {
         ...
         try {
            if (isGameOver() == true && currentPlayer == playerNumber)
            {
